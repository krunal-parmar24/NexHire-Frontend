...
export default function LoginRegisterModal({ visible = true, onHide = () => {} }: Props) {
        ...
        <div className="flex border-b border-gray-100 bg-gray-50/50">
          <button 
            className={classNames(
              ...
              tab === "login" ? "text-indigo-600 border-b-2 border-indigo-600 bg-white" : "text-gray-500 hover:text-gray-700"
            )}
          ...
          <button 
            className={classNames(
              "flex-1 py-4 text-center font-semibold text-sm tracking-wide transition-colors outline-none",
              tab === "register" ? "text-indigo-600 border-b-2 border-indigo-600 bg-white" : "text-gray-500 hover:text-gray-700"
            )}
        ...
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-3 text-sm">
              {tab === "login" ? "Enter your details to access your dashboard." : "Join NexHire to find your next opportunity."}
            </p>
          </div>
          ...
          {tab === "register" && (
            <form onSubmit={handleRegister} className="flex flex-col gap-5">
              <RoleSelectionCards selectedRole={selectedRole} onSelect={setSelectedRole} />
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                <label htmlFor="terms" className="text-sm text-gray-600 cursor-pointer leading-tight">
                  I accept the <a href="#" className="text-indigo-600 hover:text-indigo-700 font-medium hover:underline">Terms of Service</a> & <a href="#" className="text-indigo-600 hover:text-indigo-700 font-medium hover:underline">Privacy Policy</a>
                </label>
              </div>
          ...
          {tab === "login" && (
            <form onSubmit={handleLogin} className="flex flex-col gap-5">
              ...
              <div className="relative flex items-center my-6">
                ...
                <span className="flex-shrink-0 mx-4 text-gray-400 text-xs font-medium uppercase tracking-wider">Or continue with demo</span>
                <div className="flex-grow border-t border-gray-200"></div>
              </div>
