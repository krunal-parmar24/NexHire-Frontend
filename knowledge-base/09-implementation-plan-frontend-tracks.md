...
- Build job posting form (Title, Description, Requirements, Location, Job Type, Salary Range, Remote/Hybrid/Onsite).
- Build dynamic screening-question builder (text/single-select/multi-select/file/yes-no/numeric field types).
- Build preset question library; build live preview mode.
